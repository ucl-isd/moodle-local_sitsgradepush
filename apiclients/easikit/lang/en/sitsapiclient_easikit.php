...
$string['settings:endpoint_combined_due_date'] = 'Get combined due date endpoint';
$string['settings:endpoint_combined_due_date:desc'] = 'Get combined due date endpoint';
