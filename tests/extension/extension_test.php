...
final class extension_test extends \advanced_testcase {
    ...
    /**
     * Test no overrides for future extension start date.
     *
     ...
     */
    public function test_no_overrides_for_future_extension_start(): void {
        global $DB;

        // Set future extension start date.
        set_config('extension_start_date', date('Y-m-d', strtotime('+1 day')), 'local_sitsgradepush');
    ...
    public function test_ec_process_extension_assign(): void {
        ...
        // Set the extension start date in the past.
        set_config('extension_start_date', date('Y-m-d', strtotime('-1 day')), 'local_sitsgradepush');
        $ec->process_extension();
