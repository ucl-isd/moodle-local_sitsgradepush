...
/**
 * Tests for EC extension on lessons.
 *
 ...
 */
final class ec_lesson_test extends ec_base {
    /**
    ...
    public function test_process_extensions_new_enrolment(): void {
        $activity = $this->setup_common_test_data('lesson');

        // Verify no initial override.
        $this->verify_override($activity, 'lesson', null, 'userid');
        ...
        $this->verify_override($activity, 'lesson', strtotime('2025-02-27 12:00'), 'userid');
    ...
    public function test_process_extensions_new_sits_mapping(): void {
        ...
        $override = [
            ...
            'deadline' => strtotime('2025-02-20 12:00'),
        ];
        ...
        manager::get_manager()->remove_mapping($this->course1->id, $this->mappingid);
        $this->verify_override($activity, 'lesson', strtotime('2025-02-20 12:00'), 'userid');
    }
}
