...
/**
 * Tests for EC extension on assignments.
 *
 ...
 */
final class ec_assign_test extends ec_base {
    /**
    ...
    public function test_process_extensions_new_enrolment(): void {
        ...
        $this->verify_override($activity, 'assign', null, 'userid');
        ...
        $this->verify_override($activity, 'assign', strtotime('2025-02-27 12:00'), 'userid');
    ...
    public function test_process_extensions_new_sits_mapping(): void {
        ...
        $override = [
            ...
            'duedate' => strtotime('2025-02-20 12:00'),
        ];
        ...
        manager::get_manager()->remove_mapping($this->course1->id, $this->mappingid);
        $this->verify_override($activity, 'assign', strtotime('2025-02-20 12:00'), 'userid');
    }
}
