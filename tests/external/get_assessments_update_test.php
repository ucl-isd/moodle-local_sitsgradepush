...
/**
 * Tests for the get_assessments_update external service access control.
 *
 ...
 */
final class get_assessments_update_test extends external_test_base {
    /**
     * Test a user without the mapassessment capability is rejected.
     *
     * @covers \local_sitsgradepush\external\get_assessments_update::execute
     * @return void
     */
    public function test_execute_rejects_without_capability(): void {
        $this->setUser($this->student);

        $result = get_assessments_update::execute($this->course1->id);
