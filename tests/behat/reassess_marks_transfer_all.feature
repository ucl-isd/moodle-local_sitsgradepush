...
Feature: Transfer all mapped sources from Moodle to SITS for re-assessment
  In order to transfer all mapped sources from Moodle to SITS for re-assessment
  As a teacher with the appropriate permissions
  I need to go to the SITS Marks Transfer dashboard page, switch to the re-assessment page and transfer all marks
  ...
  Scenario: Transfer all marks to SITS
    ...
    And I should see "2" marks to transfer for "OSCE"
    ...
    Then I should see "0" marks to transfer for "OSCE"
