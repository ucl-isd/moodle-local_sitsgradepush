...
$string['dashboard:extensions:desc'] = 'SoRA extensions can be automatically applied to this assessment once mapped. A scheduled task will run to check for any updates on SITS every hour.';
$string['dashboard:extensions:mapped:desc'] = 'SoRA extensions are automatically applied to this assessment. A scheduled task will run to check for any updates on SITS every hour.';
...
$string['dashboard:remove_btn_content_extension'] = ' including automated SoRA extension groups and EC/DAP extension user overrides';
...
$string['settings:astcodessora'] = 'SITS assessment AST Codes for SORA';
$string['settings:astcodessora:desc'] = 'SITS assessment AST Codes that would apply to SORA';
