...
$string['dashboard:remove_btn_content'] = '{$a->warning} Are you sure you want to remove source <strong>{$a->sourcename}</strong> for SITS assessment <strong>({$a->mabseq}) {$a->mabname}</strong>?';
$string['dashboard:remove_btn_title'] = 'Remove source';
$string['dashboard:remove_extension_warning'] = 'All automatically created SoRA extensions will be removed from this Moodle source.';
