...
$string['confirmmodal:nonsubmission'] = 'Record non-submissions as 0 AB - only use after you have checked the EC and DAPs reports and taken into account any Reasonable Academic Adjustments (RAAs) extended deadlines.';
...
$string['dashboard:extensions:mapped:desc'] = 'Extensions are automatically applied to this assessment. A scheduled task will run to check for any updates on SITS.';
$string['dashboard:extensions:view'] = 'View extensions';
$string['dashboard:header'] = 'SITS assessment mapping';
$string['dashboard:header:desc'] = 'Transfer marks from Moodle to SITS, and automate SITS extension data in Moodle.';
...
$string['dashboard:remove_btn_content'] = 'Are you sure you want to remove source <strong>{$a->sourcename}</strong> for SITS assessment <strong>({$a->mabseq}) {$a->mabname}</strong>{$a->warning}?';
$string['dashboard:remove_btn_content_extension'] = ' including automated Reasonable Academic Adjustments (RAAs) extension groups and EC/DAP extension user overrides';
...
$string['error:asmnttypecodenotset'] = 'Assessment type code not set for RAA required provisions.';
...
$string['error:assessmentextensiontiernotset'] = 'Assessment extension tier for student is not set.';
...
$string['error:assessmentmappingsourcenotfound'] = 'The source for this assessment mapping is not found.';
$string['error:assessmentnotfound'] = 'Error getting assessment. Type: {$a->type}, ID: {$a->id}';
...
$string['error:candidate_number_academic_year_mismatch'] = 'Candidate number\'s academic year does not match the course academic year. Course ID: {$a->courseid}, Academic Year: {$a->academic_year}, User ID: {$a->userid}';
$string['error:candidate_number_not_found'] = 'Candidate number not found for user with ID: {$a->userid} in course with ID: {$a->courseid}.';
...
$string['error:cannot_unserialize_singleton'] = 'Cannot unserialize singleton class. Classname: {$a}';
$string['error:cannotaddusertogroup'] = 'Cannot add user to the Reasonable Academic Adjustments (RAAs) group';
...
$string['error:cannotgetsoragroupid'] = 'Cannot get Reasonable Academic Adjustments (RAAs) group ID';
...
$string['error:course_academic_year_not_set'] = 'Course CLC academic year not set. Course ID: {$a->courseid}';
...
$string['error:ecextensionnotsupported'] = 'EC/DAP extension is not supported for this assessment.';
...
$string['error:extensiondurationrequired'] = 'Duration must be provided for time per hour extension type.';
$string['error:extensionfeedbacktrackernotinstalled'] = 'Feedback tracker plugin is not installed. It is required for calculating extensions with closure days.';
$string['error:extensioninvalidunit'] = 'Invalid extension unit \'{$a}\' for time extension type.';
$string['error:extensionnewtduedatedaysonly'] = 'Get new due date method only supports days extension type.';
$string['error:extensionunsupportedtype'] = 'Unsupported extension type \'{$a}\'.';
$string['error:failed_to_fetch_scn_from_sits'] = 'Failed to fetch candidate numbers from SITS: {$a}';
$string['error:failed_to_get_scn_for_student'] = 'Failed to get candidate numbers for student: {$a}';
$string['error:failed_to_queue_fetch_scn_task'] = 'Failed to queue fetch candidate numbers task: {$a}';
$string['error:failed_to_save_candidate_number'] = 'Failed to save candidate numbers: {$a}';
...
$string['error:invalid_extension_scenario'] = 'Invalid RAA extension case.';
...
$string['error:missing_required_provisions'] = 'Required provisions data is missing.';
...
$string['error:student_not_found_from_api'] = 'Student not found from SITS API MAB: {$a->mabidentifier}, Student Code: {$a->studentcode}';
$string['error:studentcode_not_set'] = 'Student code not set. User ID: {$a->userid}}';
...
$string['manualprocessextensions'] = 'Process extensions';
$string['manualprocessextensions:allcourses'] = 'All courses';
$string['manualprocessextensions:alreadyqueued'] = 'A task with overlapped scope is already queued.';
$string['manualprocessextensions:confirm'] = 'Are you sure you want to queue the extension processing task?<br><br><strong>Scope:</strong> {$a->scope}<br><strong>Extension type:</strong> {$a->extensiontype}';
$string['manualprocessextensions:confirmcourseid'] = 'Course ID: {$a}';
$string['manualprocessextensions:courseid'] = 'Course ID (optional)';
$string['manualprocessextensions:courseid_help'] = 'Leave empty to process all courses, or enter a specific course ID to limit processing to that course only.';
$string['manualprocessextensions:desc'] = 'Queue a background task to process extensions (RAA and/or EC/DAP) for all extension-enabled assessment mappings. Leave course ID empty to process all courses.';
$string['manualprocessextensions:extensiondisabled'] = 'Extension feature is not enabled.';
$string['manualprocessextensions:extensiontype'] = 'Extension type';
$string['manualprocessextensions:extensiontype:both'] = 'Both RAA and EC/DAP';
$string['manualprocessextensions:extensiontype:ec'] = 'EC/DAP only';
$string['manualprocessextensions:extensiontype:raa'] = 'RAA only';
$string['manualprocessextensions:nomappings'] = 'No extension-enabled mappings found for this course.';
$string['manualprocessextensions:submit'] = 'Queue task';
$string['manualprocessextensions:success'] = 'Extension processing task has been queued successfully.';
...
$string['privacy:metadata:local_sitsgradepush_mapping'] = 'Stores the assessment component mappings.';
$string['privacy:metadata:local_sitsgradepush_mapping:userid'] = 'The user who created the mapping.';
$string['privacy:metadata:local_sitsgradepush_overrides'] = 'Stores the extension overrides for students.';
$string['privacy:metadata:local_sitsgradepush_overrides:userid'] = 'The user who has the extension override.';
$string['privacy:metadata:local_sitsgradepush_scn'] = 'Stores the student candidate numbers for each academic year.';
...
$string['selectsource:modal:enddate'] = 'End date';
$string['selectsource:modal:extensions'] = 'Extensions';
$string['selectsource:modal:importextension'] = 'Import extensions';
$string['selectsource:modal:mapcode'] = 'Map code';
$string['selectsource:modal:name'] = 'Name';
$string['selectsource:modal:sequence'] = 'Sequence';
$string['selectsource:modal:sitsassessment'] = 'SITS Assessment';
$string['selectsource:modal:subtitle'] = 'Map SITS assessment';
$string['selectsource:modal:tomoodleactivity'] = 'to Moodle activity';
$string['selectsource:modal:type'] = 'Type';
$string['selectsource:modal:viewguide'] = 'View the guide on automating extensions in Moodle';
...
$string['settings:astcodessora'] = 'SITS assessment AST Codes for Reasonable Academic Adjustments (RAAs)';
$string['settings:astcodessora:desc'] = 'SITS assessment AST Codes that would apply to Reasonable Academic Adjustments (RAAs)';
...
$string['settings:awsecqueueurl'] = 'AWS EC/DAP Queue URL';
$string['settings:awsecqueueurl:desc'] = 'URL for receiving EC/DAP SQS messages';
...
$string['settings:awssoraqueueurl'] = 'AWS Reasonable Academic Adjustments (RAAs) Queue URL';
...
$string['settings:enableassesstypeupdate:desc'] = 'Enable update assessment type to the local assessment type plugin';
...
$string['settings:fetch_scn_enabled:desc'] = 'Fetch candidate numbers from SITS if enabled.';
...
$string['settings:new_feature_notification_enabled'] = 'Enable New Feature Notification';
$string['settings:new_feature_notification_enabled:desc'] = 'When enabled, a new feature notification will be displayed';
$string['settings:new_feature_notification_html'] = 'New Feature Notification HTML';
$string['settings:new_feature_notification_html:desc'] = 'HTML content for the new feature notification';
$string['settings:new_feature_notification_template_html'] = '
<p><span class="badge bg-warning">New</span>
<span>Reasonable Academic Adjustments (RAAs) extensions from Portico can now be automatically applied to assignment and quiz activities in Moodle. <a href="#" target="_blank">View the guide on automating RAAs extensions in Moodle.</a></span></p>';
$string['settings:raaineligibleastcodes'] = 'RAA ineligible AST codes';
$string['settings:raaineligibleastcodes:desc'] = 'AST codes not eligible for RAA extension (separated by comma)';
...
$string['task:fetch_candidate_numbers_task'] = 'Fetch candidate numbers from SITS';
$string['task:process_aws_ec_updates'] = 'Process AWS EC/DAP updates';
$string['task:process_aws_sora_updates'] = 'Process AWS Reasonable Academic Adjustment (RAA) updates';
$string['task:process_extensions_all_mappings'] = 'Process Reasonable Academic Adjustment (RAA) and EC/DAP extensions for all eligible assessments';
$string['task:process_extensions_new_enrolment'] = 'Process Reasonable Academic Adjustment (RAA) and EC/DAP extensions for new student enrolment';
$string['task:process_extensions_new_mapping'] = 'Process Reasonable Academic Adjustment (RAA) and EC/DAP extensions for new assessment mapping';
