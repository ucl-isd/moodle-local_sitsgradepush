...
$string['error:cannotgetsoragroupid'] = 'Cannot SORA group ID';
...
$string['error:extensionstartdate'] = 'Extension start date is not set.';
...
$string['settings:extension_start_date'] = 'Extension Start Date';
$string['settings:extension_start_date:desc'] = 'Extension (EC / SORA) will be applied to associated assessments with SITS mapping\'s create date after this date';
