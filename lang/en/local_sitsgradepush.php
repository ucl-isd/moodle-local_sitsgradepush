...
$string['settings:awsecqueueurl'] = 'AWS EC Queue URL';
$string['settings:awsecqueueurl:desc'] = 'URL for receiving EC SQS messages';
...
$string['settings:enableextension:desc'] = 'Allow extension (EC / RAA) to be applied to assessments automatically';
...
$string['task:process_aws_ec_updates'] = 'Process AWS EC updates';
$string['task:process_aws_sora_updates'] = 'Process AWS Reasonable Academic Adjustment (RAA) updates';
$string['task:process_extensions_new_enrolment'] = 'Process Reasonable Academic Adjustment (RAA) and EC extensions for new student enrolment';
$string['task:process_extensions_new_mapping'] = 'Process Reasonable Academic Adjustment (RAA) and EC extensions for new assessment mapping';
