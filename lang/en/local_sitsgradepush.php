...
$string['sitsgradepush:manageextensiontiers'] = 'Manage Extension Tiers';
...
$string['tier'] = 'Tier';
$string['tier:assessmenttype'] = 'Assessment Type';
$string['tier:break'] = 'Break';
$string['tier:confirmimport'] = 'Confirm Import';
$string['tier:csvfile'] = 'CSV File';
$string['tier:csvfile_help'] = 'Upload a CSV file with extension tier configuration. Required columns: Assessment Type, Tier, Extension Type, Extension Value, Extension Unit, Break Value, Enabled';
$string['tier:csvparseerror'] = 'CSV parsing error: {$a}';
$string['tier:csvtemplate_desc'] = 'Download the CSV template file to see the correct format and example data.';
$string['tier:currentconfiguration'] = 'Current Configuration';
$string['tier:downloadtemplate'] = 'Download CSV Template';
$string['tier:enabled'] = 'Enabled';
$string['tier:error:csvloadfailed'] = 'Failed to load CSV file: {$a}';
$string['tier:error:daysnobreak'] = '{$a}Extension type "days" cannot have break value';
$string['tier:error:emptyassessmenttype'] = '{$a}Assessment type is required';
$string['tier:error:emptycsvfile'] = 'CSV file is empty';
$string['tier:error:extensionvaluerequired'] = '{$a}Extension value is required';
$string['tier:error:invalidcsvheaders'] = 'Invalid CSV headers. Expected: Assessment Type, Tier, Extension Type, Extension Value, Extension Unit, Break Value';
$string['tier:error:invalidextensiontype'] = '{$a}Invalid extension type. Must be: time, time_per_hour, or days';
$string['tier:error:invalidtier'] = '{$a}Invalid tier. Must be: 1, 2, or 3';
$string['tier:error:templatenotfound'] = 'Template file not found';
$string['tier:error:timenobreak'] = '{$a}Extension type "time" cannot have break value';
$string['tier:error:timeperhouronevalue'] = '{$a}Extension type "time_per_hour" must have either extension value or break value (or both)';
$string['tier:error:timeunitinvalid'] = '{$a}Extension type "time" must use "minutes" or "hours" unit';
$string['tier:exporttiers'] = 'Export to CSV';
$string['tier:extension'] = 'Extension';
$string['tier:importfailed'] = 'Import failed: {$a}';
$string['tier:importmode'] = 'Import Mode';
$string['tier:importmode_help'] = 'Replace: Delete all existing tiers and import new data. Update: Update existing tiers and add new ones.';
$string['tier:importmode_replace'] = 'Replace all existing tiers';
$string['tier:importmode_update'] = 'Update existing tiers';
$string['tier:importpreview'] = 'Import Preview';
$string['tier:importreplacewarn'] = 'Warning: This will delete all {$a} existing tier configurations and replace with the imported data.';
$string['tier:importsuccessful'] = '{$a} tier configurations imported successfully';
$string['tier:importtiers'] = 'Import Extension Tiers';
$string['tier:manageextensiontiers'] = 'Manage Extension Tiers';
$string['tier:manageextensiontiers_desc'] = 'Configure extension tiers for different assessment types. Upload a CSV file to import or update extension tier configurations.';
$string['tier:minutesperhour'] = 'minutes per hour';
$string['tier:newconfiguration'] = 'New Configuration';
$string['tier:notiersconfigured'] = 'No extension tiers configured yet. Import a CSV file to add tier configurations.';
$string['tier:perhour'] = 'per hour';
$string['tier:preview'] = 'Preview';
$string['tier:rowstoimport'] = 'Rows to import: {$a}';
