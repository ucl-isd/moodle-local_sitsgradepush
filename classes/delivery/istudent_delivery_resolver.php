...
/**
 * Resolves the SITS module deliveries a student belongs to.
 *
 ...
 */
interface istudent_delivery_resolver {
    /**
     * Resolve the deliveries a student belongs to in a course.
     *
     * @param int $courseid
     * @param int $userid
     * @return delivery_key[] Empty when the student cannot be resolved to any delivery.
     */
