 ...
 */
class portico_delivery_source implements idelivery_source {
    /**
    ...
    public function get_course_deliveries(int $courseid): array {
        ...
        foreach ($manager->get_local_component_grades($modocc) as $moduledelivery) {
            ...
            $name = $moduledelivery->modoccname ?: $moduledelivery->modcode;
            $deliveries[] = new delivery($key, $name, $components);
        }
