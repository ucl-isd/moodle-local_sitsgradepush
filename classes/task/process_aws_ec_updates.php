...
/**
 * Scheduled task to process AWS EC updates.
 *
 ...
 */
class process_aws_ec_updates extends \core\task\scheduled_task {
    /**
    ...
    public function get_name() {
        return get_string('task:process_aws_ec_updates', 'local_sitsgradepush');
    }
