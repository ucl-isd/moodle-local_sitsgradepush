...
class extensionmanager {
        ...
        try {
            ...
            foreach ($backups as $backup) {
                if (!$assessment[$backup->cmid]) {
                    $assessment[$backup->cmid] = assessmentfactory::get_assessment(assessmentfactory::SOURCETYPE_MOD, $backup->cmid);
                }
     ...
     * @throws \dml_exception
     */
    public static function get_overrides_by_mapid(int $mapid, string $extensiontype): mixed {
        global $DB;
