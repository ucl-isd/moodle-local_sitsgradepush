...
class lesson extends activity {
    ...
    protected function apply_ec_extension(ec $ec): void {
        ...
        $this->overrides_deadline($newduedate, null, $ec->get_userid());
    ...
    protected function apply_sora_extension(sora $sora): void {
        ...
        $this->overrides_deadline($newduedate, $timelimit, 0, $groupid);
    }
    ...
    /**
     * Overrides the deadline for the user or group.
     *
     ...
     * @return void
     */
    private function overrides_deadline(int $newdeadline, ?int $timelimit, int $userid, ?int $groupid = null): void {
        global $CFG, $DB;
        require_once($CFG->dirroot . '/mod/lesson/locallib.php');
